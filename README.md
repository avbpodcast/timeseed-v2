...
**No servers. No accounts. No key exchange server required.**

Security relies on pre-shared secrets:  
- A **50-character TimeSeed** (which can be public)  
- An optional **secret pepper password** (strongly recommended for extra security)
...
- Website: [https://timeseed.io](https://timeseed.io)  (also the Locking companion site can be used from there)
